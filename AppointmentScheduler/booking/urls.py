...
urlpatterns = [
    ...
    path('timeslots/<int:pk>/update/', TimeSlotUpdateView.as_view(), name='timeslot-update'),
    path('timeslots/<int:pk>/delete/', TimeSlotDeleteView.as_view(), name='timeslot-delete'),
